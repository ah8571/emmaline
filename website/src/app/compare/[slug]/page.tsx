    ...
    >
      ...
      <section className="space-y-4">
        ...
        <p className="leading-8 text-white/70">
          {competitor.name} is a stronger fit for {competitor.audience.toLowerCase()} Emmaline is a stronger fit for users who want a more focused AI phone assistant feel, more direct phone-style interaction, and eventually a dedicated assistant setup rather than just another general voice interface.
        </p>
      </section>
